    ...
    return BacktestRunHistory(
        runs=[
            BacktestRunSummary(
                ...
                benchmark_symbol=str(row.metrics.get("benchmark_symbol", "SELF")),
                adjustment=str(row.metrics.get("adjustment", "none")),
                bar_count=row.bar_count,
                trade_count=row.trade_count,
                total_return=float(row.metrics.get("total_return", 0)),
                excess_return=float(row.metrics.get("excess_return", 0)),
